...
<!-- Title -->
<title>Previous Year Paper - DCA | GEU </title>
      <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12 text-center">
                <h1 class="text-center fw-bold display-4 mb-5">Previous Year Paper</h1>
            </div>    
        </div>
      </div>
  </section>
...
<section>
    <form class="d-flex p-3 tcolor"  method="POST" action="questionpaper.php">
...
<option value="<?php echo $i; ?>" <?php if($InputSemester==$i) { echo "Selected"; }?>><?php echo $i; ?></option>
      ...
      <div class="form-group ">
        <label for="section-dropdown">Paper Type:</label>
...
{
     $studenterrormsg="Question Paper is not uploaded yet";
...
<?php } else {
 ?>
 <div>
          <label id="lnkdownloadhere"   style="cursor:pointer; font-size:15px;  color:blue; margin-right: 80px"><a href="<?php echo $imageencodesrc; ?>"  download="<?php echo "TimeTable_".$inputsessionyearType."_".$course_name."_".$InputSemesterType."_".$InputSectionType; ?>"  >Click Here to download</a></label>
        </div>
