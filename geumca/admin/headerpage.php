...
//$modulename=$result['popupname'];
                                    ...
                                    { ?> <a href="headerpage.php?header_id=<?php echo $result['header_id'];?>&action=Hide&model=HeaderPage" onclick="return confirm('Do you really want to Hide <?php echo $result['header_name'] ?> Module?');">Hide <?php }
                                     else { ?><a href="headerpage.php?header_id=<?php echo $result['header_id'];?>&action=Show&model=HeaderPage" onclick="return confirm('Do you really want to Show <?php echo $result['header_name'] ?> Module?');"> Show <?php } ?></td>
                                    <td><?php echo  $user_login_name; ?></td>
                                    <td><?php echo $upadted_user_login_name; ?></td>
                                    <td><a href="Header_update.php?header_id=<?php echo urlencode(base64_encode($id)); ?>"><span class='fas fa-edit'></span></a></td>
                                    <td><a href="Header_delete.php?header_id=<?php echo urlencode(base64_encode($id)); ?>"><span class='fas fa-trash'></span></a></td>       
...
//$modulename=$result['popupname'];
                                    ...
                                    { ?> <a href="headerpage.php?header_id=<?php echo $sqlformoreheaderresult['header_id'];?>&action=Hide&model=MoreHeaderPage" onclick="return confirm('Do you really want to Hide <?php echo $sqlformoreheaderresult['header_name'] ?> Module?');">Hide <?php }
                                     else { ?><a href="headerpage.php?header_id=<?php echo $sqlformoreheaderresult['header_id'];?>&action=Show&model=MoreHeaderPage" onclick="return confirm('Do you really want to Show <?php echo $sqlformoreheaderresult['header_name'] ?> Module?');"> Show <?php } ?></td>
                                    <td><?php echo  $user_login_name; ?></td>
                                    <td><?php echo $upadted_user_login_name; ?></td>
                                    <td><a href="Header_update.php?header_id=<?php echo urlencode(base64_encode($id)); ?>"><span class='fas fa-edit'></span></a></td>
                                    <td><a href="Header_delete.php?header_id=<?php echo urlencode(base64_encode($id)); ?>"><span class='fas fa-trash'></span></a></td>       
...
$query=mysqli_query($con, "UPDATE `header` SET `header_display`='InActive',`header_displayclosetime`='$date',`header_displaycloseby`='$log' WHERE `header_id`='$pid'");
echo '<script>alert("Module Hide Succesfully")</script>';
  echo "<script>window.location.href='headerpage.php?AppType=64%20|%20ApplicationType=website%20Content&Mid=1'</script>";
}
...
{    
  ...
  $date=date("Y-m-d h:i:sa");
$pid=intval($_GET['header_id']);    
$query=mysqli_query($con, "UPDATE `header` SET `header_display`='Active',`header_showdatetime`='$date',`header_showby`='$log' WHERE `header_id`='$pid'");
...
$pid=intval($_GET['header_id']);    
$query=mysqli_query($con, "UPDATE `header` SET `header_display`='InActive',`header_displayclosetime`='$date',`header_displaycloseby`='$log' WHERE `header_id`='$pid'");
echo "<script language='javascript'>alert('Module Hide Succesfully');window.location='headerpage.php?AppType=64%20|%20ApplicationType=website%20Content&Mid=1'</script>";
}
